namespace Golub.Result
{
    ...
    public class Result<T> : Result, IResult<T>
    {
        ...
        {
            return new() { Succeeded = false, Messages = [message] };
        }

        public static ErrorResult<T> ReturnError(string message)
        {
            return new() { Succeeded = false, Messages = [message], ErrorCode = 500 };
        }
        ...
        {
            return new() { Succeeded = true, Messages = [message] };
        }
        ...
        {
            return new() { Succeeded = true, Data = data, Messages = [message] };
        }
